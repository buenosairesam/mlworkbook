INSERT ilc_workbook(workbook_title,lang,workbook_price,active,hash,created_at,updated_at)VALUES("Extrait du Cahier d'Exercices", 'fr',0,1,'W0003',NOW(),NOW());
SET @currworkbook := LAST_INSERT_ID();
INSERT INTO ilc_workbook_chapter ( chapter_title, workbook_id, active, created_at, updated_at) VALUES ( "Ecriture des chiffres - Ecris en lettres le nombre présenté entre parenthèses.", @currworkbook, 1, NOW(), NOW());
SET @currchap := LAST_INSERT_ID();
INSERT INTO ilc_workbook_chapter_exercise ( exercise_title, directions, active, chapter_id, created_at, updated_at) VALUES ( "FB","", 1, @currchap, NOW(), NOW());
