INSERT ilc_workbook(workbook_title,lang,workbook_price,active,hash,created_at,updated_at)VALUES("Cahier d' Exercices 1", 'fr',0,1,'W0003',NOW(),NOW());
...
INSERT INTO ilc_workbook_chapter_exercise ( exercise_title, directions, active, chapter_id, created_at, updated_at) VALUES ( "Ecriture des chiffres","Ecris en lettres le nombre présenté entre parenthà¨ses.", 1, @currchap, NOW(), NOW());
...
INSERT INTO ilc_workbook_chapter_exercise_item (exercise_type, text, exercise_id, created_at, updated_at) VALUES ( 0, "l' hà´pital", @currex, NOW(), NOW() );
SET @curritem := LAST_INSERT_ID();
INSERT INTO ilc_workbook_chapter_exercise_item_answer ( item_id, word_index, text, is_correct_answer) VALUES (@curritem,NULL,"le", 0);
...
INSERT INTO ilc_workbook_chapter_exercise_item_answer ( item_id, word_index, text, is_correct_answer) VALUES (@curritem,NULL,"une", 0);
INSERT INTO ilc_workbook_chapter_exercise_item_answer ( item_id, word_index, text, is_correct_answer) VALUES (@curritem,NULL,"des", 0);
INSERT INTO ilc_workbook_chapter_exercise ( exercise_title, directions, active, chapter_id, created_at, updated_at) VALUES ( "Compléter","Complà¨te avec le verbe 'àªtre' conjugué à  la personne qui convient.", 1, @currchap, NOW(), NOW());
SET @currex := LAST_INSERT_ID();
...
INSERT INTO ilc_workbook_chapter_exercise_item (exercise_type, text, exercise_id, created_at, updated_at) VALUES ( 1, "Vous àªtes patients.", @currex, NOW(), NOW() );
SET @curritem := LAST_INSERT_ID();
INSERT INTO ilc_workbook_chapter_exercise_item_answer ( item_id, word_index, text, is_correct_answer) VALUES (@curritem,1,"àªtes", 1);
...
INSERT INTO ilc_workbook_chapter_exercise ( exercise_title, directions, active, chapter_id, created_at, updated_at) VALUES ( "Compléter","Complà¨te avec le verbe 'avoir' conjugué à  la personne qui convient.", 1, @currchap, NOW(), NOW());
SET @currex := LAST_INSERT_ID();
...
INSERT INTO ilc_workbook_chapter_exercise_item (exercise_type, text, exercise_id, created_at, updated_at) VALUES ( 1, "J' ai un frà¨re et une soeur.", @currex, NOW(), NOW() );
SET @curritem := LAST_INSERT_ID();
INSERT INTO ilc_workbook_chapter_exercise_item_answer ( item_id, word_index, text, is_correct_answer) VALUES (@curritem,1,"ai", 1);
...
INSERT INTO ilc_workbook_chapter_exercise ( exercise_title, directions, active, chapter_id, created_at, updated_at) VALUES ( "Compléter","Complà¨te avec le verbe entre parenthà¨ses conjugué à  la personne qui convient.", 1, @currchap, NOW(), NOW());
SET @currex := LAST_INSERT_ID();
INSERT INTO ilc_workbook_chapter_exercise_item (exercise_type, text, exercise_id, created_at, updated_at) VALUES ( 1, "Nous étudions (étudier) le franà§ais.", @currex, NOW(), NOW() );
SET @curritem := LAST_INSERT_ID();
